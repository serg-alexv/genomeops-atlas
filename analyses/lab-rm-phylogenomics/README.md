...
Stage 1 is implemented by `.github/workflows/lab-rm-genome-discovery.yml` and `scripts/discover_genomes.sh`. The fixed-field run report is frozen in `results/STAGE1_2026-08-26.md`.
